...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'models/asphalt_plane'), glob('models/asphalt_plane/*.*')),
        (os.path.join('share', package_name, 'models/asphalt_plane/materials/textures'), glob('models/asphalt_plane/materials/textures/*')),
        (os.path.join('share', package_name, 'models/asphalt_plane/materials/scripts'), glob('models/asphalt_plane/materials/scripts/*')),
